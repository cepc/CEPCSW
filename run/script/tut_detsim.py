...
# geometry_option = "CepC_v4-onlyTracker_2MDC_R1800.xml"
...
# gun.Energies = [1.0] # GeV
gun.Energies = [0.5] # GeV
#gun.Energies = [0.3] # GeV

# gun.ThetaMins = [] # rad; 45deg
# gun.ThetaMaxs = [] # rad; 45deg

# gun.ThetaMins = [ 90.0 ] # rad; 45deg
# gun.ThetaMaxs = [ 90.0 ] # rad; 45deg
...
out.filename = "../run/output/test-detsim200.root"
#out.filename = "../run/output/test-detsim10.root"
