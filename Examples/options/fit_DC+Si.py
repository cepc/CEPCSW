...
from Configurables import EcalFastSimG4Tool
ecal_fastsim_tool = EcalFastSimG4Tool("EcalFastSimG4Tool")
ecal_fastsim_tool.Regions = ["EcalBarrelRegion"]
...
subset.RawTrackerHitCollections = [vxdhitname, sithitname, sitspname, ftdhitname, ftdspname]
...
truthTrackerAlg.maxDigiCut=150
#truthTrackerAlg.useSiTruthHit=True
#truthTrackerAlg.OutputLevel=DEBUG
#truthTrackerAlg.useTruthTrack=True
#truthTrackerAlg.useSi=False
#truthTrackerAlg.useDC=False
#truthTrackerAlg.resVertexX=3
#truthTrackerAlg.resVertexY=3
#truthTrackerAlg.resVertexZ=10
...
#recGenfitAlgSDT.debug=2
recGenfitAlgSDT.debugPid=1
#recGenfitAlgSDT.OutputLevel=DEBUG
recGenfitAlgSDT.isUseFixedSiHitError=True
#recGenfitAlgSDT.fitSiliconOnly=True
...
#recGenfitAlgDC.debug=20
#recGenfitAlgDC.debugPid=1
#recGenfitAlgDC.sigmaHit=10
#recGenfitAlgDC.OutputLevel=DEBUG
...
ntsvc.Output = [
"TruthTrackerAlg DATAFILE='truthTrackerAlg_SDT.root' OPT='NEW' TYP='ROOT'"
,"RecGenfitAlgSDT DATAFILE='recGenfitAlgSDT.root' OPT='NEW' TYP='ROOT'"
#,"RecGenfitAlgDC DATAFILE='recGenfitAlgSDT.root' OPT='NEW' TYP='ROOT'"
]

# output
from Configurables import PodioOutput
out = PodioOutput("outputalg")
#out.filename = "CRD_o1_v02-SimRecFit00_SDT.root"
...
ApplicationMgr(
    ...
    digiVXD, digiSIT, digiSET, digiFTD,
    spSIT, spSET, spFTD, tracking, forward, subset, full, 
    dCHDigiAlg, truthTrackerAlg, recGenfitAlgSDT,
    out],
    EvtSel = 'NONE',
    EvtMax = 10,
    ExtSvc = [rndmengine, rndmgensvc, dsvc,
              evtseeder, geosvc, gearsvc, tracksystemsvc, ntsvc],
...
#    spSIT, spSET, spFTD, tracking, forward, subset, full,
#    dCHDigiAlg,
#    truthTrackerAlg, recGenfitAlgSDT, out],
#    EvtSel = 'NONE',
#    EvtMax = 10,
#    ExtSvc = [rndmengine, rndmgensvc, dsvc,
#    evtseeder, geosvc, gearsvc, tracksystemsvc, ntsvc],
