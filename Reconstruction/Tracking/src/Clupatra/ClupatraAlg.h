...
class ClupatraAlg : public GaudiAlgorithm {
 ...
 protected:
  ...
  DataHandle<edm4hep::TrackCollection> _ClupatraTrackCollectionHandle{"ClupatraTrack", Gaudi::DataHandle::Writer, this};
  DataHandle<edm4hep::TrackCollection> _ClupatraTrackSegmentCollectionHandle{"ClupatraSegmentTrack", Gaudi::DataHandle::Writer, this};
